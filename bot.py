...
async def approve(_, m : Message):
    ...
    try:
        ...
        await app.send_text(text="**Hello {}!\nWelcome To {}\n\n__Powerd By : @CxBotz__**".format(m.from_user.mention, m.chat.title))
        add_user(kk.id)
    ...
    try:
        ...
        if m.chat.type == enums.ChatType.PRIVATE:
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("• ϲнαииєℓ •", url="https://t.me/CxMaxTG"),
                        InlineKeyboardButton("• gяουρ •", url="https://CinemaxpressTM")
                    ],[
            ...
            await m.reply_text(text="**🦊 Hello {}!\nI'm an auto approve [Admin Join Requests]({}) Bot.\nI can approve users in Groups/Channels.Add me to your chat and promote me to admin with add members permission.\n\n__Powerd By : @CxBotz__**".format(m.from_user.mention, "https://t.me/telegram/153"), reply_markup=keyboard)
    
        elif m.chat.type == enums.ChatType.GROUP or enums.ChatType.SUPERGROUP:
            keyboar = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("💁‍♂️ Start me private 💁‍♂️", url="https://t.me/Cxautobot?start=start")
                    ]
                ]
            )
            add_group(m.chat.id)
        ...
        if cb.message.chat.type == enums.ChatType.PRIVATE:
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("• ϲнαииєℓ •", url="https://t.me/CxMaxTG"),
                        InlineKeyboardButton("• gяουρ •", url="https://t.me/CinemaxpressTM")
                    ],[
                        InlineKeyboardButton("➕ Add me to your Chat ➕", url="https://t.me/Cxautobot?startgroup")
                    ]
                ]
            ...
            await cb.message.edit("**🦊 Hello {}!\nI'm an auto approve [Admin Join Requests]({}) Bot.\nI can approve users in Groups/Channels.Add me to your chat and promote me to admin with add members permission.\n\n__Powerd By : @SdBotz__**".format(cb.from_user.mention, "https://t.me/telegram/153"), reply_markup=keyboard)
